...
💖 [이력서(Resume)](https://drive.google.com/file/d/1MyUsPkeIJm-qBgurEFrAl6p-FYOl39eh/view?usp=sharing) 💖

<br>

## 📬 Contact Me

Email: [nicodora12@icloud.com](mailto:nicodora12@icloud.com)
<br>
...
| ----------------------- | :------------------------------------------------------------------: | :--------------: | ------------------------------------------------------ |
| 2025.05.19 ~            |                 [P-Pick](https://github.com/P-pick)                  | Design & Backend | _2025 관광데이터 활용 공모전_                          |
| 2025.01.14 ~ 2025.04.07 |              [Honey Moa](https://github.com/honey-moa)               |     Backend      | _연인과의 꿀처럼 달콤한 추억을 모으는 서비스_          |
| 2025.01.14 ~ 2025.01.28 | [Its Your Duck!](https://github.com/bokduck-bang/its-your-duck-back) |     Backend      | _복덕이를 통해 소중한 사람들과 덕담을 주고받는 캠페인_ |
| 2023.05.31 ~ 2024.03.08 |     [Modern Agile (6term)](https://github.com/modern-agile-team)     |     Backend      | _애자일 방법론 기반 교내 웹 개발 동아리 (6기 부회장)_  |
...
**"복덕이를 통해 소중한 사람들과 덕담을 주고받는 캠페인"** - _(2025.01.14 ~ 2025.01.28)_
...
- 소셜 로그인 도입으로 가입/로그인 절차를 3단계에서 1단계로 간소화하여 초기 이탈률 37% 감소
- 세션보다 인증 및 관리에 부담이 없는 JWT를 채택하여 안전하고 빠른 인증•인가 시스템 구현
- [passport strategy를 사용하여 JWT 인증로직 간소화 및 재사용성 향상](https://github.com/modern-agile-team/Menbosha-back/pull/240)
- Redis의 데이터 휘발성을 해결하기 위해 RDB (snapshot) 백업 및 복원 자동화로 데이터 영속성을 보장하여 사용자 경험 향상
- 멘토의 기여도를 측정하고 Cron을 사용해 1주일마다 인기 멘토를 선정하는 자동화 기능 구현
...
**애자일 방법론 기반 교내 웹 개발 동아리** - _(2023.06.01 ~ 2024.03.08)_

- 6기 부회장 및 백엔드 팀원으로서 동아리 운영 및 프로젝트 참여
- 데일리 스크럼, 애자일 스프린트(2주 단위)와 회고, 칸반보드를 통해 빠른 피드백 수용 및 팀 협업 능력 강화
- 2주마다 테크톡(Tech Talk)을 진행하여 자기주도적 학습을 통해 얻은 지식을 팀원들과 공유하여 지식 전달 및 발표 역량 강화
